execute if data storage horsey:main {type:"minecraft:horse"} run playsound entity.horse.angry neutral @s ~ ~ ~ 64 0.9
execute if data storage horsey:main {type:"minecraft:donkey"} run playsound entity.donkey.angry neutral @s ~ ~ ~ 64 0.9
execute if data storage horsey:main {type:"minecraft:mule"} run playsound entity.mule.angry neutral @s ~ ~ ~ 64 0.9
